const he = {
  ...
  aiTier: {
    ...
    dialogSubtitle: 'מגבלות שימוש יומיות לכל פיצ׳ר',
  ...
  createPOI: {
    ...
    category: 'קטגוריה',
    placeType: 'סוג מקום',
    choosePlaceType: 'בחר סוג מקום...',
    activityType: 'סוג פעילות',
    chooseActivityType: 'בחר סוג פעילות...',
    location: 'מיקום',
    country: 'מדינה',
  ...
  timeline: {
    ...
    noDestinations: 'עדיין לא הוספתם יעדים',
    addPlace: 'הוסף מקום',
